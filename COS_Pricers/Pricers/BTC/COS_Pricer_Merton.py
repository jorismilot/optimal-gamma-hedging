...
if __name__ == '__main__':
    ...
    for hour in hours:
        ...
        summary_filepath = os.path.join(output_path, 'Calibration', f'{hour}', f'merton_calibration_summary_{hour}.csv')
        ...
        if option_fits:
            ...
            detailed_filepath = os.path.join(output_path, 'Options', f'{hour}', f'merton_per_option_fits_{hour}.csv')
